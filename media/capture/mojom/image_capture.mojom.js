...
(function() {
  ...
  var BackgroundBlurMode = {};
  BackgroundBlurMode.OFF = 0;
  BackgroundBlurMode.BLUR = 1;
  BackgroundBlurMode.MIN_VALUE = 0;
  BackgroundBlurMode.MAX_VALUE = 1;
  BackgroundBlurMode.DEFAULT_VALUE = 0;

  BackgroundBlurMode.isKnownEnumValue = function(value) {
    switch (value) {
    case 0:
    case 1:
      return true;
  ...
  BackgroundBlurMode.toKnownEnumValue = function(value) {
    if (this.isKnownEnumValue(value))
      return value;
    return this.DEFAULT_VALUE;
  };

  BackgroundBlurMode.validate = function(enumValue) {
  ...
  MeteringMode.SINGLE_SHOT = 2;
  MeteringMode.CONTINUOUS = 3;
  ...
  MeteringMode.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  RedEyeReduction.ALWAYS = 1;
  RedEyeReduction.CONTROLLABLE = 2;
  ...
  RedEyeReduction.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  var FillLightMode = {};
  FillLightMode.OFF = 0;
  FillLightMode.AUTO = 1;
  FillLightMode.FLASH = 2;
  ...
  FillLightMode.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  PhotoState.validate = function(messageValidator, offset) {
    ...
    // version check PhotoState.supportedBackgroundBlurModes
    if (!messageValidator.isFieldInStructVersion(offset, 1))
      return validator.validationError.NONE;
    // validate PhotoState.supportedBackgroundBlurModes
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 176, 4, new codec.Enum(BackgroundBlurMode), true, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;



    // version check PhotoState.backgroundBlurMode
    if (!messageValidator.isFieldInStructVersion(offset, 1))
      return validator.validationError.NONE;
    // validate PhotoState.backgroundBlurMode
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 148, BackgroundBlurMode);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  PhotoState.encodedSize = codec.kStructHeaderSize + 184;
  ...
  PhotoState.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.supportedWhiteBalanceModes =
        decoder.decodeArrayPointer(new codec.Enum(MeteringMode));
    val.currentWhiteBalanceMode =
        decoder.decodeStruct(new codec.Enum(MeteringMode));
    val.currentExposureMode =
        decoder.decodeStruct(new codec.Enum(MeteringMode));
    val.supportedExposureModes =
        decoder.decodeArrayPointer(new codec.Enum(MeteringMode));
    ...
    val.pointsOfInterest =
        decoder.decodeArrayPointer(new codec.PointerTo(Point2D));
    val.exposureCompensation =
        decoder.decodeStructPointer(Range);
    val.exposureTime =
        decoder.decodeStructPointer(Range);
    ...
    val.zoom =
        decoder.decodeStructPointer(Range);
    val.redEyeReduction =
        decoder.decodeStruct(new codec.Enum(RedEyeReduction));
    if (version >= 1) {
      val.backgroundBlurMode =
          decoder.decodeStruct(new codec.Enum(BackgroundBlurMode));
    } else {
      val.backgroundBlurMode = null;
    }
    val.height =
        decoder.decodeStructPointer(Range);
    val.width =
        decoder.decodeStructPointer(Range);
    val.fillLightMode =
        decoder.decodeArrayPointer(new codec.Enum(FillLightMode));
    if (version >= 1) {
      val.supportedBackgroundBlurModes =
          decoder.decodeArrayPointer(new codec.Enum(BackgroundBlurMode));
    } else {
      val.supportedBackgroundBlurModes = null;
    }
    return val;
  };
  ...
  PhotoState.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(codec.Int32, val.backgroundBlurMode);
  ...
  PhotoSettings.validate = function(messageValidator, offset) {
    ...
    // version check PhotoSettings.backgroundBlurMode
    if (!messageValidator.isFieldInStructVersion(offset, 1))
      return validator.validationError.NONE;
    // validate PhotoSettings.backgroundBlurMode
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 124, BackgroundBlurMode);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  PhotoSettings.decode = function(decoder) {
    ...
    val.zoom =
        decoder.decodeStruct(codec.Double);
    val.fillLightMode =
        decoder.decodeStruct(new codec.Enum(FillLightMode));
    if (version >= 1) {
      val.backgroundBlurMode =
          decoder.decodeStruct(new codec.Enum(BackgroundBlurMode));
    } else {
  ...
  ImageCapture_GetPhotoState_ResponseParams.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.state =
        decoder.decodeStructPointer(PhotoState);
    return val;
  };
  ...
  function ImageCapture_SetPhotoOptions_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  ImageCapture_SetPhotoOptions_Params.prototype.initDefaults_ = function() {
    this.sourceId = null;
    this.settings = null;
  };
  ImageCapture_SetPhotoOptions_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  ImageCapture_SetPhotoOptions_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate ImageCapture_SetPhotoOptions_Params.sourceId
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 0, false)
    if (err !== validator.validationError.NONE)
        return err;


    // validate ImageCapture_SetPhotoOptions_Params.settings
  ...
  ImageCapture_SetPhotoOptions_Params.encodedSize = codec.kStructHeaderSize + 16;

  ImageCapture_SetPhotoOptions_Params.decode = function(decoder) {
    var packed;
    var val = new ImageCapture_SetPhotoOptions_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.sourceId =
        decoder.decodeStruct(codec.String);
    val.settings =
        decoder.decodeStructPointer(PhotoSettings);
    return val;
  };

  ImageCapture_SetPhotoOptions_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(ImageCapture_SetPhotoOptions_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.String, val.sourceId);
    encoder.encodeStructPointer(PhotoSettings, val.settings);
  };
  function ImageCapture_SetPhotoOptions_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  ImageCapture_SetPhotoOptions_ResponseParams.prototype.initDefaults_ = function() {
    this.success = false;
  };
  ImageCapture_SetPhotoOptions_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  ImageCapture_SetPhotoOptions_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  ImageCapture_SetPhotoOptions_ResponseParams.encodedSize = codec.kStructHeaderSize + 8;

  ImageCapture_SetPhotoOptions_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new ImageCapture_SetPhotoOptions_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    packed = decoder.readUint8();
  ...
  ImageCapture_SetPhotoOptions_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(ImageCapture_SetPhotoOptions_ResponseParams.encodedSize);
    encoder.writeUint32(0);
    packed = 0;
  ...
  ImageCapture_TakePhoto_ResponseParams.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.blob =
        decoder.decodeStructPointer(Blob);
    return val;
  };
  ...
  var kImageCapture_SetPhotoOptions_Name = 1;
  ...
  ImageCapturePtr.prototype.setPhotoOptions = function() {
    return ImageCaptureProxy.prototype.setPhotoOptions
        .apply(this.ptr.getProxy(), arguments);
  };

  ImageCaptureProxy.prototype.setPhotoOptions = function(sourceId, settings) {
    var params_ = new ImageCapture_SetPhotoOptions_Params();
    params_.sourceId = sourceId;
    params_.settings = settings;
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageV1Builder(
          kImageCapture_SetPhotoOptions_Name,
          codec.align(ImageCapture_SetPhotoOptions_Params.encodedSize),
          codec.kMessageExpectsResponse, 0);
      builder.encodeStruct(ImageCapture_SetPhotoOptions_Params, params_);
      var message = builder.finish();
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        var reader = new codec.MessageReader(message);
        var responseParams =
            reader.decodeStruct(ImageCapture_SetPhotoOptions_ResponseParams);
        resolve(responseParams);
      }).catch(function(result) {
        reject(Error("Connection error: " + result));
      });
  ...
  ImageCaptureStub.prototype.setPhotoOptions = function(sourceId, settings) {
    return this.delegate_ && this.delegate_.setPhotoOptions && this.delegate_.setPhotoOptions(sourceId, settings);
  }
  ...
  ImageCaptureStub.prototype.acceptWithResponder =
    ...
    case kImageCapture_GetPhotoState_Name:
      ...
      return true;
    case kImageCapture_SetPhotoOptions_Name:
      var params = reader.decodeStruct(ImageCapture_SetPhotoOptions_Params);
      this.setPhotoOptions(params.sourceId, params.settings).then(function(response) {
        var responseParams =
            new ImageCapture_SetPhotoOptions_ResponseParams();
        responseParams.success = response.success;
        var builder = new codec.MessageV1Builder(
            kImageCapture_SetPhotoOptions_Name,
            codec.align(ImageCapture_SetPhotoOptions_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(ImageCapture_SetPhotoOptions_ResponseParams,
                             responseParams);
        var message = builder.finish();
        responder.accept(message);
      });
  ...
  function validateImageCaptureRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kImageCapture_SetPhotoOptions_Name:
        if (message.expectsResponse())
          paramsClass = ImageCapture_SetPhotoOptions_Params;
      break;
      case kImageCapture_TakePhoto_Name:
        if (message.expectsResponse())
  ...
  function validateImageCaptureResponse(messageValidator) {
   ...
   switch (message.getName()) {
      ...
      case kImageCapture_SetPhotoOptions_Name:
        if (message.isResponse())
          paramsClass = ImageCapture_SetPhotoOptions_ResponseParams;
        break;
      case kImageCapture_TakePhoto_Name:
        if (message.isResponse())
