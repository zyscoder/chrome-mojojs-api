...
(function() {
  ...
  VideoCapturePixelFormat.MAX_VALUE = 36;
  ...
  VideoCaptureError.MAX_VALUE = 148;
  ...
  DeviceEnumerationResult.MAX_VALUE = 2;
  ...
  VideoCaptureFeedback.validate = function(messageValidator, offset) {
    ...
    // version check VideoCaptureFeedback.dEPRECATEDMappedSizes
  ...
  VideoCaptureFeedback.decode = function(decoder) {
    ...
    if (version >= 1) {
      ...
      val.dEPRECATEDMappedSizes = null;
    }
    return val;
  };
