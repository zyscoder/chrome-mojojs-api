...
(function() {
  ...
  MediaUrlParams.decode = function(decoder) {
    ...
    val.allowCredentials = (packed >> 1) & 1 ? true : false;
    val.isHls = (packed >> 2) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  MediaUrlParams.encode = function(encoder, val) {
    ...
    packed |= (val.allowCredentials & 1) << 1
    packed |= (val.isHls & 1) << 2
  ...
  var kRenderer_Initialize_Name = 2103303337;
  var kRenderer_Flush_Name = 1132523474;
  var kRenderer_StartPlayingFrom_Name = 2045553489;
  var kRenderer_SetPlaybackRate_Name = 1188971234;
  var kRenderer_SetVolume_Name = 2055525211;
  var kRenderer_SetCdm_Name = 386266142;
  ...
  var kRendererClient_OnTimeUpdate_Name = 1228246972;
  var kRendererClient_OnBufferingStateChange_Name = 44471597;
  var kRendererClient_OnEnded_Name = 223665234;
  var kRendererClient_OnError_Name = 805546412;
  var kRendererClient_OnAudioConfigChange_Name = 2095261825;
  var kRendererClient_OnVideoConfigChange_Name = 310091577;
  var kRendererClient_OnVideoNaturalSizeChange_Name = 528574685;
  var kRendererClient_OnVideoOpacityChange_Name = 672529251;
  var kRendererClient_OnStatisticsUpdate_Name = 1444098605;
  var kRendererClient_OnWaiting_Name = 126314764;
