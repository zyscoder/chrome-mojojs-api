...
(function() {
  ...
  PlaybackProperties.validate = function(messageValidator, offset) {
    ...
    // validate PlaybackProperties.rendererType
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 8, media_types$.RendererType);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  PlaybackProperties.encodedSize = codec.kStructHeaderSize + 16;
  ...
  var kWatchTimeRecorder_RecordWatchTime_Name = 1317831979;
  var kWatchTimeRecorder_FinalizeWatchTime_Name = 642425194;
  var kWatchTimeRecorder_OnError_Name = 683060386;
  var kWatchTimeRecorder_UpdateSecondaryProperties_Name = 1050306948;
  var kWatchTimeRecorder_SetAutoplayInitiated_Name = 1077742464;
  var kWatchTimeRecorder_OnDurationChanged_Name = 1184730675;
  var kWatchTimeRecorder_UpdateVideoDecodeStats_Name = 2013330976;
  var kWatchTimeRecorder_UpdateUnderflowCount_Name = 452224048;
  var kWatchTimeRecorder_UpdateUnderflowDuration_Name = 84500376;
  var kWatchTimeRecorder_OnCurrentTimestampChanged_Name = 1624619318;
