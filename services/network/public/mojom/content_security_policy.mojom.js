...
(function() {
  ...
  CSPSourceList.decode = function(decoder) {
    ...
    val.allowInlineSpeculationRules = (packed >> 4) & 1 ? true : false;
    val.allowEval = (packed >> 5) & 1 ? true : false;
    val.allowWasmEval = (packed >> 6) & 1 ? true : false;
    val.allowWasmUnsafeEval = (packed >> 7) & 1 ? true : false;
    packed = decoder.readUint8();
    val.allowDynamic = (packed >> 0) & 1 ? true : false;
    val.allowUnsafeHashes = (packed >> 1) & 1 ? true : false;
    val.reportSample = (packed >> 2) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  CSPSourceList.encode = function(encoder, val) {
    ...
    packed |= (val.allowInlineSpeculationRules & 1) << 4
    packed |= (val.allowEval & 1) << 5
    packed |= (val.allowWasmEval & 1) << 6
    packed |= (val.allowWasmUnsafeEval & 1) << 7
    encoder.writeUint8(packed);
    packed = 0;
    packed |= (val.allowDynamic & 1) << 0
    packed |= (val.allowUnsafeHashes & 1) << 1
    packed |= (val.reportSample & 1) << 2
    encoder.writeUint8(packed);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
