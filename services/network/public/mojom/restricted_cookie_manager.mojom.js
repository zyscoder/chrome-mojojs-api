...
(function() {
  ...
  var kRestrictedCookieManager_GetAllForUrl_Name = 1020702818;
  var kRestrictedCookieManager_SetCanonicalCookie_Name = 647583981;
  var kRestrictedCookieManager_AddChangeListener_Name = 1566033045;
  var kRestrictedCookieManager_SetCookieFromString_Name = 1680047988;
  var kRestrictedCookieManager_GetCookiesString_Name = 1872075176;
  var kRestrictedCookieManager_CookiesEnabledFor_Name = 33379116;
  ...
  RestrictedCookieManagerProxy.prototype.setCanonicalCookie = function(cookie, url, siteForCookies, topFrameOrigin, hasStorageAccess, status) {
  ...
  RestrictedCookieManagerProxy.prototype.addChangeListener = function(url, siteForCookies, topFrameOrigin, hasStorageAccess, listener) {
  ...
  RestrictedCookieManagerProxy.prototype.setCookieFromString = function(url, siteForCookies, topFrameOrigin, hasStorageAccess, cookie) {
  ...
  RestrictedCookieManagerProxy.prototype.cookiesEnabledFor = function(url, siteForCookies, topFrameOrigin, hasStorageAccess) {
  ...
  RestrictedCookieManagerStub.prototype.addChangeListener = function(url, siteForCookies, topFrameOrigin, hasStorageAccess, listener) {
    return this.delegate_ && this.delegate_.addChangeListener && this.delegate_.addChangeListener(url, siteForCookies, topFrameOrigin, hasStorageAccess, listener);
  }
  ...
  RestrictedCookieManagerStub.prototype.acceptWithResponder =
    ...
    case kRestrictedCookieManager_SetCanonicalCookie_Name:
      ...
      this.setCanonicalCookie(params.cookie, params.url, params.siteForCookies, params.topFrameOrigin, params.hasStorageAccess, params.status).then(function(response) {
        var responseParams =
    ...
    case kRestrictedCookieManager_AddChangeListener_Name:
      ...
      this.addChangeListener(params.url, params.siteForCookies, params.topFrameOrigin, params.hasStorageAccess, params.listener).then(function(response) {
        var responseParams =
    ...
    case kRestrictedCookieManager_SetCookieFromString_Name:
      ...
      this.setCookieFromString(params.url, params.siteForCookies, params.topFrameOrigin, params.hasStorageAccess, params.cookie).then(function(response) {
        var responseParams =
    ...
    case kRestrictedCookieManager_CookiesEnabledFor_Name:
      ...
      this.cookiesEnabledFor(params.url, params.siteForCookies, params.topFrameOrigin, params.hasStorageAccess).then(function(response) {
        var responseParams =
