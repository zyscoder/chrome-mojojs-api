...
(function() {
  ...
  function TCPServerSocketOptions(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  TCPServerSocketOptions.prototype.initDefaults_ = function() {
    this.backlog = 0;
    this.ipv6Only = 0;
  };
  TCPServerSocketOptions.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  TCPServerSocketOptions.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate TCPServerSocketOptions.ipv6Only
  ...
  TCPServerSocketOptions.encodedSize = codec.kStructHeaderSize + 8;

  TCPServerSocketOptions.decode = function(decoder) {
    var packed;
    var val = new TCPServerSocketOptions();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.backlog =
  ...
  TCPServerSocketOptions.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(TCPServerSocketOptions.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.Uint32, val.backlog);
    encoder.encodeStruct(codec.Int32, val.ipv6Only);
  };
  ...
  var kTCPBoundSocket_Listen_Name = 705763958;
  var kTCPBoundSocket_Connect_Name = 1575295025;
  ...
  var kTCPConnectedSocket_UpgradeToTLS_Name = 349193547;
  var kTCPConnectedSocket_SetSendBufferSize_Name = 2023046996;
  var kTCPConnectedSocket_SetReceiveBufferSize_Name = 552730442;
  var kTCPConnectedSocket_SetNoDelay_Name = 1769980656;
  var kTCPConnectedSocket_SetKeepAlive_Name = 1667525437;
  ...
  var kSocketObserver_OnReadError_Name = 1075865232;
  var kSocketObserver_OnWriteError_Name = 1066389158;
  ...
  var kTCPServerSocket_Accept_Name = 1970033633;
  ...
  exports.TCPServerSocketOptions = TCPServerSocketOptions;
