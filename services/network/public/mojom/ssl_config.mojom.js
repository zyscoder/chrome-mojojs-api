...
(function() {
  ...
  SSLConfig.prototype.initDefaults_ = function() {
    ...
    this.postQuantumOverride = optional_bool$.OptionalBool.kUnset;
    this.disabledCipherSuites = null;
    this.clientCertPoolingPolicy = null;
    this.insecureHashOverride = optional_bool$.OptionalBool.kUnset;
    this.rsaKeyUsageForLocalAnchorsOverride = optional_bool$.OptionalBool.kUnset;
  };
  ...
  SSLConfig.validate = function(messageValidator, offset) {
    ...
    // validate SSLConfig.postQuantumOverride
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 12, optional_bool$.OptionalBool);
    if (err !== validator.validationError.NONE)
        return err;



    // validate SSLConfig.insecureHashOverride
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 32, optional_bool$.OptionalBool);
    if (err !== validator.validationError.NONE)
        return err;


    // validate SSLConfig.rsaKeyUsageForLocalAnchorsOverride
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 36, optional_bool$.OptionalBool);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  SSLConfig.encodedSize = codec.kStructHeaderSize + 40;
  ...
  SSLConfig.decode = function(decoder) {
    ...
    val.echEnabled = (packed >> 4) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    val.versionMin =
    ...
    val.insecureHashOverride =
        decoder.decodeStruct(new codec.Enum(optional_bool$.OptionalBool));
    val.rsaKeyUsageForLocalAnchorsOverride =
        decoder.decodeStruct(new codec.Enum(optional_bool$.OptionalBool));
    return val;
  };
  ...
  SSLConfig.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(codec.Int32, val.postQuantumOverride);
    ...
    encoder.encodeStruct(codec.Int32, val.insecureHashOverride);
    encoder.encodeStruct(codec.Int32, val.rsaKeyUsageForLocalAnchorsOverride);
  };
  ...
  var kSSLConfigClient_OnSSLConfigUpdated_Name = 1933131357;
