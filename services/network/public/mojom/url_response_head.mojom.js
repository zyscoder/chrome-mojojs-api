...
(function() {
  ...
  URLResponseHead.validate = function(messageValidator, offset) {
    ...
    // validate URLResponseHead.triggerVerifications
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 232, 8, new codec.PointerTo(attribution$.TriggerVerification), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
