...
(function() {
  ...
  UDPSocketOptions.validate = function(messageValidator, offset) {
    ...
    // validate UDPSocketOptions.ipv6Only
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 20, optional_bool$.OptionalBool);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  var kUDPSocket_Bind_Name = 5733871;
  var kUDPSocket_Connect_Name = 339892561;
  var kUDPSocket_SetBroadcast_Name = 390490407;
  var kUDPSocket_SetSendBufferSize_Name = 439628740;
  var kUDPSocket_SetReceiveBufferSize_Name = 298237655;
  var kUDPSocket_JoinGroup_Name = 342086410;
  var kUDPSocket_LeaveGroup_Name = 2040611083;
  var kUDPSocket_ReceiveMore_Name = 909077732;
  var kUDPSocket_ReceiveMoreWithBufferSize_Name = 1015598929;
  var kUDPSocket_SendTo_Name = 2007871932;
  var kUDPSocket_Send_Name = 1590440448;
  var kUDPSocket_Close_Name = 642866792;
  ...
  var kUDPSocketListener_OnReceived_Name = 1554276355;
