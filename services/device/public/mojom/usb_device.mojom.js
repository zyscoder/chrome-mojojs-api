...
(function() {
  ...
  var UsbOpenDeviceSuccess = {};
  UsbOpenDeviceSuccess.OK = 0;
  UsbOpenDeviceSuccess.MIN_VALUE = 0;
  UsbOpenDeviceSuccess.MAX_VALUE = 0;

  UsbOpenDeviceSuccess.isKnownEnumValue = function(value) {
    switch (value) {
    case 0:
      return true;
    }
  ...
  UsbOpenDeviceSuccess.toKnownEnumValue = function(value) {
    return value;
  };

  UsbOpenDeviceSuccess.validate = function(enumValue) {
  ...
  UsbOpenDeviceError.ACCESS_DENIED = 0;
  UsbOpenDeviceError.ALREADY_OPEN = 1;
  UsbOpenDeviceError.MIN_VALUE = 0;
  UsbOpenDeviceError.MAX_VALUE = 1;
  ...
  UsbDevice_Open_ResponseParams.validate = function(messageValidator, offset) {
    ...
    // validate UsbDevice_Open_ResponseParams.result
    err = messageValidator.validateUnion(offset + codec.kStructHeaderSize + 0, UsbOpenDeviceResult, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  UsbDevice_Open_ResponseParams.encodedSize = codec.kStructHeaderSize + 16;
  ...
  UsbDevice_Open_ResponseParams.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.result =
        decoder.decodeStruct(UsbOpenDeviceResult);
    return val;
  };
  ...
  UsbDevice_Open_ResponseParams.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStruct(UsbOpenDeviceResult, val.result);
  };
  ...
  function UsbOpenDeviceResult(value) {
    this.initDefault_();
    this.initValue_(value);
  }


  UsbOpenDeviceResult.Tags = {
    success: 0,
    error: 1,
  };

  UsbOpenDeviceResult.prototype.initDefault_ = function() {
    this.$data = null;
    this.$tag = undefined;
  }

  UsbOpenDeviceResult.prototype.initValue_ = function(value) {
    if (value == undefined) {
      return;
    }
    ...
    if (fields.indexOf(keys[0]) < 0) {
      throw new ReferenceError(keys[0] + " is not a UsbOpenDeviceResult member.");

    }

    this[keys[0]] = value[keys[0]];
  }
  Object.defineProperty(UsbOpenDeviceResult.prototype, "success", {
    get: function() {
      if (this.$tag != UsbOpenDeviceResult.Tags.success) {
        throw new ReferenceError(
            "UsbOpenDeviceResult.success is not currently set.");
      }
      return this.$data;
    },

    set: function(value) {
      this.$tag = UsbOpenDeviceResult.Tags.success;
      this.$data = value;
    }
  });
  Object.defineProperty(UsbOpenDeviceResult.prototype, "error", {
    get: function() {
      if (this.$tag != UsbOpenDeviceResult.Tags.error) {
        throw new ReferenceError(
            "UsbOpenDeviceResult.error is not currently set.");
      }
      return this.$data;
    },

    set: function(value) {
      this.$tag = UsbOpenDeviceResult.Tags.error;
      this.$data = value;
    }
  });


    UsbOpenDeviceResult.encode = function(encoder, val) {
      if (val == null) {
      ...
      switch (val.$tag) {
        case UsbOpenDeviceResult.Tags.success:
          encoder.encodeStruct(codec.Int32, val.success);
          break;
        case UsbOpenDeviceResult.Tags.error:
    ...
    UsbOpenDeviceResult.decode = function(decoder) {
      ...
      var result = new UsbOpenDeviceResult();
      var tag = decoder.readUint32();
      switch (tag) {
        case UsbOpenDeviceResult.Tags.success:
          result.success = decoder.decodeStruct(new codec.Enum(UsbOpenDeviceSuccess));
          break;
        case UsbOpenDeviceResult.Tags.error:
          result.error = decoder.decodeStruct(new codec.Enum(UsbOpenDeviceError));
          break;
      }
      decoder.align();
    ...
    UsbOpenDeviceResult.validate = function(messageValidator, offset) {
    ...
    // validate UsbOpenDeviceResult.success
    err = messageValidator.validateEnum(data_offset, UsbOpenDeviceSuccess);
    if (err !== validator.validationError.NONE)
        return err;
          break;
        case UsbOpenDeviceResult.Tags.error:
    ...
    // validate UsbOpenDeviceResult.error
    err = messageValidator.validateEnum(data_offset, UsbOpenDeviceError);
    if (err !== validator.validationError.NONE)
        return err;
          break;
      }
  ...
  UsbOpenDeviceResult.encodedSize = 16;
  ...
  exports.UsbOpenDeviceSuccess = UsbOpenDeviceSuccess;
  ...
  exports.UsbOpenDeviceResult = UsbOpenDeviceResult;
