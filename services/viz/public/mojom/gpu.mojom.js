...
(function() {
  ...
  GpuMemoryBufferFactory_DestroyGpuMemoryBuffer_Params.encodedSize = codec.kStructHeaderSize + 8;
  ...
  function Gpu_CreateClientGpuMemoryBufferFactory_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  Gpu_CreateClientGpuMemoryBufferFactory_Params.prototype.initDefaults_ = function() {
    this.receiver = new bindings.InterfaceRequest();
  };
  Gpu_CreateClientGpuMemoryBufferFactory_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  Gpu_CreateClientGpuMemoryBufferFactory_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate Gpu_CreateClientGpuMemoryBufferFactory_Params.receiver
    err = messageValidator.validateInterfaceRequest(offset + codec.kStructHeaderSize + 0, false)
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Gpu_CreateClientGpuMemoryBufferFactory_Params.encodedSize = codec.kStructHeaderSize + 8;

  Gpu_CreateClientGpuMemoryBufferFactory_Params.decode = function(decoder) {
    var packed;
    var val = new Gpu_CreateClientGpuMemoryBufferFactory_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.receiver =
        decoder.decodeStruct(codec.InterfaceRequest);
  ...
  Gpu_CreateClientGpuMemoryBufferFactory_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(Gpu_CreateClientGpuMemoryBufferFactory_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.InterfaceRequest, val.receiver);
    encoder.skip(1);
    encoder.skip(1);
  ...
  var kGpuMemoryBufferFactory_CreateGpuMemoryBuffer_Name = 1435605945;
  var kGpuMemoryBufferFactory_DestroyGpuMemoryBuffer_Name = 2046508838;
  var kGpuMemoryBufferFactory_CopyGpuMemoryBuffer_Name = 78540496;
  ...
  GpuMemoryBufferFactoryProxy.prototype.destroyGpuMemoryBuffer = function(id) {
  ...
  GpuMemoryBufferFactoryStub.prototype.destroyGpuMemoryBuffer = function(id) {
  ...
  var kGpu_CreateGpuMemoryBufferFactory_Name = 2137856946;
  var kGpu_CreateClientGpuMemoryBufferFactory_Name = 727074150;
  var kGpu_EstablishGpuChannel_Name = 1730918671;
  var kGpu_CreateVideoEncodeAcceleratorProvider_Name = 406668120;
  ...
  GpuPtr.prototype.createClientGpuMemoryBufferFactory = function() {
    return GpuProxy.prototype.createClientGpuMemoryBufferFactory
        .apply(this.ptr.getProxy(), arguments);
  };

  GpuProxy.prototype.createClientGpuMemoryBufferFactory = function(receiver) {
    var params_ = new Gpu_CreateClientGpuMemoryBufferFactory_Params();
    params_.receiver = receiver;
    var builder = new codec.MessageV0Builder(
        kGpu_CreateClientGpuMemoryBufferFactory_Name,
        codec.align(Gpu_CreateClientGpuMemoryBufferFactory_Params.encodedSize));
    builder.encodeStruct(Gpu_CreateClientGpuMemoryBufferFactory_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  GpuStub.prototype.createClientGpuMemoryBufferFactory = function(receiver) {
    return this.delegate_ && this.delegate_.createClientGpuMemoryBufferFactory && this.delegate_.createClientGpuMemoryBufferFactory(receiver);
  }
  ...
  GpuStub.prototype.accept = function(message) {
    ...
    case kGpu_CreateGpuMemoryBufferFactory_Name:
      ...
      return true;
    case kGpu_CreateClientGpuMemoryBufferFactory_Name:
      var params = reader.decodeStruct(Gpu_CreateClientGpuMemoryBufferFactory_Params);
      this.createClientGpuMemoryBufferFactory(params.receiver);
      return true;
  ...
  function validateGpuRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kGpu_CreateClientGpuMemoryBufferFactory_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = Gpu_CreateClientGpuMemoryBufferFactory_Params;
      break;
      case kGpu_EstablishGpuChannel_Name:
        if (message.expectsResponse())
