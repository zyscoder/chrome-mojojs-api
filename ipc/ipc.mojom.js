...
(function() {
  ...
  var generic_pending_associated_receiver$ =
      mojo.internal.exposeNamespace('mojoBase.mojom');
  if (mojo.config.autoLoadMojomDeps) {
    mojo.internal.loadMojomIfNecessary(
        'mojo/public/mojom/base/generic_pending_associated_receiver.mojom', '../mojo/public/mojom/base/generic_pending_associated_receiver.mojom.js');
  }
  ...
  Channel_GetAssociatedInterface_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, generic_pending_associated_receiver$.GenericPendingAssociatedReceiver, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Channel_GetAssociatedInterface_Params.encodedSize = codec.kStructHeaderSize + 8;
  ...
  Channel_GetAssociatedInterface_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.receiver =
        decoder.decodeStructPointer(generic_pending_associated_receiver$.GenericPendingAssociatedReceiver);
    return val;
  };
  ...
  Channel_GetAssociatedInterface_Params.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStructPointer(generic_pending_associated_receiver$.GenericPendingAssociatedReceiver, val.receiver);
  };
  var kChannel_SetPeerPid_Name = 1261234378;
  var kChannel_Receive_Name = 678178796;
  var kChannel_GetAssociatedInterface_Name = 1157731001;
  ...
  ChannelProxy.prototype.getAssociatedInterface = function(receiver) {
  ...
  ChannelStub.prototype.getAssociatedInterface = function(receiver) {
    return this.delegate_ && this.delegate_.getAssociatedInterface && this.delegate_.getAssociatedInterface(receiver);
  }
  ...
  ChannelStub.prototype.accept = function(message) {
    ...
    case kChannel_GetAssociatedInterface_Name:
      ...
      this.getAssociatedInterface(params.receiver);
      return true;
    default:
      return false;
    }
