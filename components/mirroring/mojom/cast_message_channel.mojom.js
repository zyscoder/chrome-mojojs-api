...
(function() {
  ...
  function CastMessageChannel_OnMessage_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  CastMessageChannel_OnMessage_Params.prototype.initDefaults_ = function() {
    this.message = null;
  };
  CastMessageChannel_OnMessage_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  CastMessageChannel_OnMessage_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate CastMessageChannel_OnMessage_Params.message
  ...
  CastMessageChannel_OnMessage_Params.encodedSize = codec.kStructHeaderSize + 8;

  CastMessageChannel_OnMessage_Params.decode = function(decoder) {
    var packed;
    var val = new CastMessageChannel_OnMessage_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.message =
  ...
  CastMessageChannel_OnMessage_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(CastMessageChannel_OnMessage_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStructPointer(CastMessage, val.message);
  };
  var kCastMessageChannel_OnMessage_Name = 963730380;
  ...
  CastMessageChannelPtr.prototype.onMessage = function() {
    return CastMessageChannelProxy.prototype.onMessage
        .apply(this.ptr.getProxy(), arguments);
  };

  CastMessageChannelProxy.prototype.onMessage = function(message) {
    var params_ = new CastMessageChannel_OnMessage_Params();
    params_.message = message;
    var builder = new codec.MessageV0Builder(
        kCastMessageChannel_OnMessage_Name,
        codec.align(CastMessageChannel_OnMessage_Params.encodedSize));
    builder.encodeStruct(CastMessageChannel_OnMessage_Params, params_);
  ...
  CastMessageChannelStub.prototype.onMessage = function(message) {
  ...
  CastMessageChannelStub.prototype.accept = function(message) {
    ...
    case kCastMessageChannel_OnMessage_Name:
      var params = reader.decodeStruct(CastMessageChannel_OnMessage_Params);
    ...
    switch (message.getName()) {
      case kCastMessageChannel_OnMessage_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = CastMessageChannel_OnMessage_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
