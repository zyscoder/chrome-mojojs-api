...
(function() {
  ...
  function Logger_BindReceiver_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  Logger_BindReceiver_Params.prototype.initDefaults_ = function() {
    this.receiver = new bindings.InterfaceRequest();
  };
  Logger_BindReceiver_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  Logger_BindReceiver_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate Logger_BindReceiver_Params.receiver
  ...
  Logger_BindReceiver_Params.encodedSize = codec.kStructHeaderSize + 8;

  Logger_BindReceiver_Params.decode = function(decoder) {
    var packed;
    var val = new Logger_BindReceiver_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.receiver =
  ...
  Logger_BindReceiver_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(Logger_BindReceiver_Params.encodedSize);
    encoder.writeUint32(0);
  ...
  var kLogger_LogInfo_Name = 982266501;
  var kLogger_LogWarning_Name = 784380393;
  var kLogger_LogError_Name = 105982345;
  var kLogger_BindReceiver_Name = 13346962;
  ...
  LoggerPtr.prototype.bindReceiver = function() {
    return LoggerProxy.prototype.bindReceiver
        .apply(this.ptr.getProxy(), arguments);
  };

  LoggerProxy.prototype.bindReceiver = function(receiver) {
    var params_ = new Logger_BindReceiver_Params();
    params_.receiver = receiver;
    var builder = new codec.MessageV0Builder(
        kLogger_BindReceiver_Name,
        codec.align(Logger_BindReceiver_Params.encodedSize));
    builder.encodeStruct(Logger_BindReceiver_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  LoggerStub.prototype.bindReceiver = function(receiver) {
  ...
  LoggerStub.prototype.accept = function(message) {
    ...
    case kLogger_LogError_Name:
      ...
      return true;
    case kLogger_BindReceiver_Name:
      var params = reader.decodeStruct(Logger_BindReceiver_Params);
  ...
  function validateLoggerRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kLogger_BindReceiver_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = Logger_BindReceiver_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
