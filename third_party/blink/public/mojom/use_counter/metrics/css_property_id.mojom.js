...
(function() {
  ...
  CSSSampleId.kInternalAlignContentBlock = 0;
  ...
  CSSSampleId.kInternalOverflowBlock = 0;
  CSSSampleId.kInternalOverflowInline = 0;
  ...
  CSSSampleId.kPopoverHideDelay = 723;
  ...
  CSSSampleId.kTextWrap = 746;
  CSSSampleId.kTextBoxTrim = 747;
  CSSSampleId.kOverlay = 748;
  CSSSampleId.kWhiteSpaceCollapse = 749;
  CSSSampleId.kScrollTimelineAttachment = 750;
  CSSSampleId.kViewTimelineAttachment = 751;
  CSSSampleId.kScrollStartBlock = 752;
  CSSSampleId.kScrollStartInline = 753;
  CSSSampleId.kScrollStartX = 754;
  CSSSampleId.kScrollStartY = 755;
  CSSSampleId.kScrollStart = 756;
  CSSSampleId.kScrollStartTargetBlock = 757;
  CSSSampleId.kScrollStartTargetInline = 758;
  CSSSampleId.kScrollStartTargetX = 759;
  CSSSampleId.kScrollStartTargetY = 760;
  CSSSampleId.kScrollStartTarget = 761;
  CSSSampleId.kTimelineScope = 762;
  CSSSampleId.kScrollbarColor = 763;
  ...
  CSSSampleId.kFormSizing = 770;
  CSSSampleId.kTextSpacingTrim = 771;
  CSSSampleId.kMaskImage = 772;
  CSSSampleId.kMaskClip = 773;
  CSSSampleId.kMaskSize = 774;
  CSSSampleId.MIN_VALUE = 0;
  CSSSampleId.MAX_VALUE = 774;
