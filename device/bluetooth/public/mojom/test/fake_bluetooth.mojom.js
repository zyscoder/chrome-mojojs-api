...
(function() {
  ...
  CentralState.POWERED_ON = 1;
  CentralState.POWERED_OFF = 2;
  ...
  CentralState.toKnownEnumValue = function(value) {
    return value;
  };
  ...
  var WriteType = {};
  WriteType.kNone = 0;
  WriteType.kWriteDefaultDeprecated = 1;
  WriteType.kWriteWithResponse = 2;
  WriteType.kWriteWithoutResponse = 3;
  WriteType.MIN_VALUE = 0;
  WriteType.MAX_VALUE = 3;

  WriteType.isKnownEnumValue = function(value) {
    switch (value) {
    case 0:
    case 1:
    case 2:
  ...
  WriteType.toKnownEnumValue = function(value) {
    return value;
  };

  WriteType.validate = function(enumValue) {
    const isExtensible = false;
    if (isExtensible || this.isKnownEnumValue(enumValue))
      return validator.validationError.NONE;
  ...
  ScanRecord.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 32, true, codec.Uint16, new codec.ArrayOf(codec.Uint8), false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  ScanRecord.decode = function(decoder) {
    ...
    val.appearance =
        decoder.decodeStructPointer(Appearance);
    val.txPower =
        decoder.decodeStructPointer(Power);
    val.manufacturerData =
        decoder.decodeMapPointer(codec.Uint16, new codec.ArrayOf(codec.Uint8));
    val.serviceData =
        decoder.decodeStructPointer(ServiceDataMap);
    return val;
  };
  ...
  ScanResult.decode = function(decoder) {
    ...
    decoder.skip(1);
    val.scanRecord =
        decoder.decodeStructPointer(ScanRecord);
    return val;
  };
  ...
  FakeBluetooth_SimulateCentral_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.state =
        decoder.decodeStruct(new codec.Enum(CentralState));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  FakeBluetooth_SimulateCentral_ResponseParams.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.fakeCentral =
        decoder.decodeStruct(new codec.Interface(FakeCentralPtr));
    return val;
  };
  ...
  FakeCentral_SimulatePreconnectedPeripheral_Params.validate = function(messageValidator, offset) {
    ...
    // validate FakeCentral_SimulatePreconnectedPeripheral_Params.manufacturerData
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 16, false, codec.Uint16, new codec.ArrayOf(codec.Uint8), false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate FakeCentral_SimulatePreconnectedPeripheral_Params.knownServiceUuids
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 24, 8, new codec.PointerTo(uuid$.UUID), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  FakeCentral_SimulatePreconnectedPeripheral_Params.encodedSize = codec.kStructHeaderSize + 32;
  ...
  FakeCentral_SimulateAdvertisementReceived_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.result =
        decoder.decodeStructPointer(ScanResult);
    return val;
  };
  ...
  FakeCentral_AddFakeCharacteristic_Params.decode = function(decoder) {
    ...
    val.characteristicUuid =
        decoder.decodeStructPointer(uuid$.UUID);
    val.properties =
        decoder.decodeStructPointer(CharacteristicProperties);
    val.serviceId =
        decoder.decodeStruct(codec.String);
    val.peripheralAddress =
        decoder.decodeStruct(codec.String);
  ...
  FakeCentral_GetLastWrittenCharacteristicValue_ResponseParams.validate = function(messageValidator, offset) {
    ...
    // validate FakeCentral_GetLastWrittenCharacteristicValue_ResponseParams.writeType
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 4, WriteType);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  FakeCentral_GetLastWrittenCharacteristicValue_ResponseParams.decode = function(decoder) {
    ...
    decoder.skip(1);
    val.writeType =
        decoder.decodeStruct(new codec.Enum(WriteType));
    val.value =
        decoder.decodeArrayPointer(codec.Uint8);
    return val;
  };
  ...
  var kFakeBluetooth_SetLESupported_Name = 2091769077;
  var kFakeBluetooth_SimulateCentral_Name = 1556006027;
  var kFakeBluetooth_AllResponsesConsumed_Name = 1087545030;
  ...
  var kFakeCentral_SimulatePreconnectedPeripheral_Name = 479205137;
  var kFakeCentral_SimulateAdvertisementReceived_Name = 1339940683;
  var kFakeCentral_SetState_Name = 342662011;
  var kFakeCentral_SetNextGATTConnectionResponse_Name = 1207230312;
  var kFakeCentral_SetNextGATTDiscoveryResponse_Name = 688314284;
  var kFakeCentral_SimulateGATTDisconnection_Name = 1188111120;
  var kFakeCentral_SimulateGATTServicesChanged_Name = 533501710;
  var kFakeCentral_AddFakeService_Name = 1766704485;
  var kFakeCentral_RemoveFakeService_Name = 1423023728;
  var kFakeCentral_AddFakeCharacteristic_Name = 1384789036;
  var kFakeCentral_RemoveFakeCharacteristic_Name = 834281109;
  var kFakeCentral_AddFakeDescriptor_Name = 514314033;
  var kFakeCentral_RemoveFakeDescriptor_Name = 102969286;
  var kFakeCentral_SetNextReadCharacteristicResponse_Name = 1917077973;
  var kFakeCentral_SetNextWriteCharacteristicResponse_Name = 1291326261;
  var kFakeCentral_SetNextSubscribeToNotificationsResponse_Name = 1395399142;
  var kFakeCentral_SetNextUnsubscribeFromNotificationsResponse_Name = 81879268;
  var kFakeCentral_IsNotifying_Name = 739920087;
  var kFakeCentral_GetLastWrittenCharacteristicValue_Name = 1245883145;
  var kFakeCentral_SetNextReadDescriptorResponse_Name = 430155382;
  var kFakeCentral_SetNextWriteDescriptorResponse_Name = 454698765;
  var kFakeCentral_GetLastWrittenDescriptorValue_Name = 937055148;
  ...
  FakeCentralProxy.prototype.simulatePreconnectedPeripheral = function(address, name, manufacturerData, knownServiceUuids) {
    var params_ = new FakeCentral_SimulatePreconnectedPeripheral_Params();
    params_.address = address;
    params_.name = name;
    params_.manufacturerData = manufacturerData;
  ...
  FakeCentralStub.prototype.simulatePreconnectedPeripheral = function(address, name, manufacturerData, knownServiceUuids) {
    return this.delegate_ && this.delegate_.simulatePreconnectedPeripheral && this.delegate_.simulatePreconnectedPeripheral(address, name, manufacturerData, knownServiceUuids);
  }
  ...
  FakeCentralStub.prototype.acceptWithResponder =
    ...
    case kFakeCentral_SimulatePreconnectedPeripheral_Name:
      ...
      this.simulatePreconnectedPeripheral(params.address, params.name, params.manufacturerData, params.knownServiceUuids).then(function(response) {
        var responseParams =
    ...
    case kFakeCentral_GetLastWrittenCharacteristicValue_Name:
      ...
      this.getLastWrittenCharacteristicValue(params.characteristicId, params.serviceId, params.peripheralAddress).then(function(response) {
        ...
        responseParams.writeType = response.writeType;
        var builder = new codec.MessageV1Builder(
            kFakeCentral_GetLastWrittenCharacteristicValue_Name,
